  ...
  <div class="container_fluid" v-if="isAdminStore">
    <div class="row flex-nowrap">
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
        <div
          class="d-flex flex-column align-items-center align-items-sm-start text-white min-vh-100 px-3 pt-2"
        >
          <ul
            ...
            <li class="nav-item pt-2">
              ...
              >
                ...
                <span class="d-none d-sm-inline mx-1"
                  >{{ user_obj?.firstname }} {{ user_obj?.username }}</span
                >
              </a>
              <ul
        ...
        <div class=".col-4 icon_header me-4 my-2">
          <ul class="navbar-nav me-auto mb-2">
            <li class="nav-item dropdown">
              ...
              >
                <li v-if="isLoggedIn_from_localstorage" class="px-3 py-2">
                  Log in as:
                </li>
                ...
                <li
                  v-if="isLoggedIn_from_localstorage"
                  class="px-3 py-2 fst-normal"
                >
                  {{ user_obj?.username }} {{ user_obj?.firstname }}
                </li>
                <li
                  v-if="isLoggedIn_from_localstorage"
                  class="px-3 py-1 fst-normal"
                >
                  {{ user_obj?.email }}
                </li>
                ...
                <li>
                  <a class="dropdown-item" href="#">
                    <router-link to="/panier_step" class="router_link_class"

  ...
  <div class="card m-3" style="width: 16rem">
    <div class="d-flex justify-content-between p-3">
      <div class="d-grid justify-content-md-end">
        <button
          ...
          @click="add_me_to_cart(props.item.id!)"
        >
          <font-awesome-icon
    ...
    <div class="image_product">
      <router-link :to="{ name: 'album_selected', params: { id: item.id } }">
        <img
          :src="getImage(props.item.cover!)"
          class="album_cover card-img-top rounded img-fluid"
          alt="album picture"
          style="height: 180px"
        />
      </router-link>
    ...
    <div class="card-body">
      <div class="d-flex justify-content-between">
        <p class="small">
          <a href="#!" class="text-muted text-decoration-none"
            >{{ check_me_artist().firstname }}
            {{ check_me_artist().lastname }}</a
          >
        </p>
      ...
      <div class="d-flex justify-content-between mb-3">
        ...
        <h5 v-if="promo && !chek_if_exist_in_promo" class="text-dark mb-0">
          $
          {{
            props.item.price - (return_promo().rate / 100) * props.item.price
          }}
        </h5>
        <h5
          v-else-if="chek_if_exist_in_promo() && promo == false"
